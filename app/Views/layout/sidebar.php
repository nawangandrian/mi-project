...
#sidebar-toggle {
    ...
    color: var(--text-on-dark-3); cursor: pointer;
    font-size: 16px; padding: 6px;
    border-radius: 6px; transition: var(--transition);
    flex-shrink: 0;
}

#sidebar-toggle:hover { color: var(--accent-cyan); background: rgba(0,151,184,0.08); }
...
.nav-item > span:not(.nav-badge) { overflow: hidden; text-overflow: ellipsis; flex: 1; min-width: 0; }
...
.sidebar-footer-text { overflow: hidden; transition: opacity 0.2s; }
...
#sidebar.collapsed .sidebar-footer-card { justify-content: center; padding: 11px 0; }
...
@media (max-width: 768px) {
    ...
    #sidebar.collapsed.mobile-open { width: var(--sidebar-width) !important; }
    ...
    #sidebar.collapsed.mobile-open .nav-item { justify-content: flex-start; padding: 9px 12px; }
    #sidebar.collapsed.mobile-open .sidebar-logo { justify-content: flex-start; padding: 18px 18px 16px; }
    #sidebar.collapsed.mobile-open .sidebar-footer-card { justify-content: flex-start; padding: 11px 12px; }
}
/* =====================================================
