...
<head>
    ...
    <title>SP2S · Sistem Prediksi Penjualan Smartphone</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-primary {
            ...
            cursor: pointer;
            transition: all 0.2s;
            box-shadow: 0 6px 24px rgba(56,189,248,0.3), 0 0 0 0 rgba(56,189,248,0);
        }
...
<section>
    <div class="hero">
        <div class="hero-content">
            ...
            <h1 class="hero-h1">
                Prediksi Cerdas<br>
                <span class="hi">Penjualan Smartphone</span><br>
        ...
        <div class="hero-visual">
            <div class="hero-panel">
                <div class="panel-header">
                    <span class="panel-title">PREDIKSI_OUTPUT · Q4/2025</span>
                    <span class="panel-status"><span class="dot"></span> MODEL AKTIF</span>
                </div>
                ...
                <div class="chart-legend">
                    <div class="legend-item">
                        <span class="legend-dot" style="background:var(--accent)"></span> Aktual
                    </div>
                    <div class="legend-item">
                ...
                <div class="panel-metrics">
                    <div class="pm-item">
                        ...
                        <div class="pm-value good">0.947</div>
                    </div>
                    <div class="pm-item">
                        <div class="pm-label">RMSE</div>
                        <div class="pm-value info">124.3</div>
                    </div>
                    <div class="pm-item">
                        <div class="pm-label">MAE</div>
                        <div class="pm-value info">89.7</div>
                    </div>
                    <div class="pm-item">
                        <div class="pm-label">MAPE</div>
                        <div class="pm-value good">4.82%</div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="stats-strip">
    <div class="stats-inner">
        ...
        <div class="stat-item">
            ...
            <div class="stat-label">BRAND SMARTPHONE</div>
        </div>
        <div class="stat-item">
    ...
    <div class="section">
        ...
        <div class="features-grid">
            ...
            <div class="feat-card">
                ...
                <p class="feat-desc">Generate laporan penjualan bulanan lengkap dengan perbandingan target vs realisasi, tren produk terlaris, dan proyeksi bulan berikutnya.</p>
            </div>
            <div class="feat-card">
...
<div class="tech-section">
    <div class="tech-inner">
        ...
        <div class="model-card">
            <div class="model-card-title">// PERFORMA MODEL · RANDOM FOREST REGRESSOR</div>
            <div class="metric-row">
                <div class="metric-item">
                    <div class="metric-label">
                        <span class="metric-name">R² Score (Koefisien Determinasi)</span>
                        <span class="metric-num">0.947</span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill blue" style="width:94.7%"></div>
                    </div>
                </div>
                <div class="metric-item">
                    <div class="metric-label">
                        <span class="metric-name">Akurasi Prediksi (1 - MAPE)</span>
                        <span class="metric-num">95.18%</span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill green" style="width:95.18%"></div>
                    </div>
                </div>
                <div class="metric-item">
                    <div class="metric-label">
                        <span class="metric-name">Cross-Validation Score (5-fold)</span>
                        <span class="metric-num">93.2%</span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill indigo" style="width:93.2%"></div>
                    </div>
                </div>
                <div class="metric-item">
                    <div class="metric-label">
                        <span class="metric-name">Feature Importance Coverage</span>
                        <span class="metric-num">87.5%</span>
                    </div>
                    <div class="metric-bar">
                        <div class="metric-fill blue" style="width:87.5%"></div>
                    </div>
                </div>
            </div>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
                    ...
                    foreach ($params as [$k, $v]): ?>
                        <div style="background:rgba(13,21,32,0.6);border:1px solid var(--border);border-radius:6px;padding:10px 12px;">
                            ...
                            <div style="font-family:var(--font-mono);font-size:14px;color:var(--accent);font-weight:700;"><?= $v ?></div>
                        </div>
                    <?php endforeach ?>
                </div>
            </div>
...
<section class="cta-section">
    <div class="cta-box">
        ...
        <a href="<?= site_url('login') ?>" class="btn-primary" style="display:inline-flex;margin:0 auto;">
            <i class="bi bi-box-arrow-in-right"></i> Masuk ke Sistem SP2S
        </a>
    </div>
</section>
